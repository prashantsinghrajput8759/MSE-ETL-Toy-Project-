...
def seleniumPageLoad(self,path):
    ...
    try:
        ele = base.WebDriverWait(base.driver, 2).until( #using explicit wait for 2 seconds
        base.EC.presence_of_element_located((base.By.XPATH, path)) #checking for the element with xpath 
    )
        print("Page is loaded within 2 seconds.")
    except:
        print("Timeout Exception: Page did not load within 2 seconds.")
